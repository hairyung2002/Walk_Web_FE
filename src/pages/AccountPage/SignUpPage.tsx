    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400">WalkingCity와 함께 산책을 시작하세요</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 ${
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 h-4 w-4 text-green-500 focus:ring-green-500 border-gray-600 rounded bg-gray-700"
                />
                <label htmlFor="agreeTerms" className="ml-3 text-sm text-gray-300">
                  <span className="text-green-400">(필수)</span> 이용약관에 동의합니다
                </label>
              </div>
              {errors.agreeTerms && <p className="text-sm text-red-400 ml-7">{errors.agreeTerms}</p>}
              ...
              {errors.agreePrivacy && <p className="text-sm text-red-400 ml-7">{errors.agreePrivacy}</p>}
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="agreeMarketing" className="ml-3 text-sm text-gray-300">
                  <span className="text-green-400">(선택)</span> 마케팅 정보 수신에 동의합니다
                </label>
              </div>
            </div>
